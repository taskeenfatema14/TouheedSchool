    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_image', models.ImageField(blank=True, help_text='Best Image Resolution width: 640 x Height: 825', null=True, upload_to='images/staff/')),
            ],
            options={
                'verbose_name': 'Staff',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.ImageField(blank=True, help_text='Best Image Resolution width: 1280 x Height: 720', null=True, upload_to='images/event/banner/')),
